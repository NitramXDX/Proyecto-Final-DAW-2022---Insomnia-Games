...
public interface PedidoRepository extends JpaRepository<PedidoVO, Integer>{
	...
	//Busqueda de lineasdepedido de un pedido
	@Query("select lp from LineaPedidoVO lp where lp.pedido.idpedido = ?1")
	public List<LineaPedidoVO> findLPS(int idpedido);
	...
	public default Map<String, Object> pagination(Map<String, Object> params, int itemPerPage) {
		...
		Page<PedidoVO> pageItem = this.findAll(pageRequest);
